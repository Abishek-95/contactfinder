...
tavily_api_key= "my_search_key"
linkedin_scraper_username="my_username"
linkedin_scrapper_apikey="my_scrapper_key"
...
class emp_bp(TypedDict):
    org_name : str 
    emp_contact :list[actual_details] = Field(strict=True)
    dep_list:list[str]
    pre_dep:str
    search_results:str
    source : str
